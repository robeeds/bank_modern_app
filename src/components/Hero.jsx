...
const Hero = () => {
  ...
  //Unlike the video at 47:44, the discount logoa and other components will not show unless there is a return statement
  return (
    ...
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`} >
      ...
      <p className={`${styles.paragraph} max-w-[470px] mt-5`}> Our team of experts uses a methodology to identify the credit cards most likey to fit your needs. We examine annual percentage rates, annual fees, and much more.</p>
      </div>
